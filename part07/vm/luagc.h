...
#define gco2tbl(o) check_exp(LUA_TTABLE == (o)->tt_, &cast(union GCUnion *, o)->tbl)
#define gco2lclosure(o) check_exp(LUA_TLCL == (o)->tt_, &cast(union GCUnion *, o)->cl.l)
#define gco2cclosure(o) check_exp(LUA_TCCL == (o)->tt_, &cast(union GCUnion *, o)->cl.c)
#define gco2proto(o) check_exp(LUA_TPROTO == (o)->tt_, &cast(union GCUnion *, o)->p)
