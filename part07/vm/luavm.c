...
static inline void op_test(struct lua_State *L, LClosure *cl, StkId ra, Instruction i)
{
    int c = GET_ARG_C(i);
...
static inline void op_testset(struct lua_State *L, LClosure *cl, StkId ra, Instruction i)
{
    int b = GET_ARG_B(i);
    int c = GET_ARG_C(i);
...
static inline void op_jump(struct lua_State *L, LClosure *cl, StkId ra, Instruction i)
{
...
static inline void op_unm(struct lua_State *L, LClosure *cl, StkId ra, Instruction i)
{
    int b = GET_ARG_B(i);
    StkId rb = L->ci->l.base + b;
    TValue o;
...
static inline void op_len(struct lua_State *L, LClosure *cl, StkId ra, Instruction i)
{
    int b = GET_ARG_B(i);
    StkId rb = L->ci->l.base + b;
    if (ttistable(rb)) {
...
static inline void op_bnot(struct lua_State *L, LClosure *cl, StkId ra, Instruction i)
{
...
static inline void op_not(struct lua_State *L, LClosure *cl, StkId ra, Instruction i)
{
    StkId rb = L->ci->l.base + GET_ARG_B(i);
...
static inline void op_add(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_ADD);
}

static inline void op_sub(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_SUB);
}

static inline void op_mul(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_MUL);
}

static inline void op_div(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_DIV);
}

static inline void op_idiv(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_IDIV);
}

static inline void op_mod(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_MOD);
}

static inline void op_pow(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_POW);
}

static inline void op_band(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_BAND);
}

static inline void op_bor(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_BOR);
}

static inline void op_bxor(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_BXOR);
}

static inline void op_shl(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_SHL);
}

static inline void op_shr(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    binop(L, cl, ra, i, LUA_OPT_SHR);
}

static inline void op_concat(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    // TODO
}

static inline void op_eq(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
...
static inline void op_lt(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    StkId rb = RK(L, cl, GET_ARG_B(i));
    StkId rc = RK(L, cl, GET_ARG_C(i));
...
static inline void op_le(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    StkId rb = RK(L, cl, GET_ARG_B(i));
    StkId rc = RK(L, cl, GET_ARG_C(i));
    lua_Number nb = 0, nc = 0;
...
static inline void op_loadbool(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
...
static inline void op_setupval(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    setobj(cl->upvals[GET_ARG_B(i)]->v, ra);
}

static inline void op_settabup(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
...
static inline void op_newtable(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
...
static inline void op_setlist(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
    if (!ttistable(ra)) {
	// TODO throw exception
...
static inline void op_settable(struct lua_State* L, LClosure* cl, StkId ra, Instruction i)
{
